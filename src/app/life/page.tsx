...
export default function LifePage() {
  return (
    <InnerPageLayout
      ...
      sections={sections}
      quotes={quotes}
      heroImage="/images/hero-life.jpg"
      heroImageAlt="Andrew Cohen as a young man among goats in the Himalayan foothills"
      heroImageCaption="Andrew Cohen in the Himalayan foothills."
      heroVariant="full"
