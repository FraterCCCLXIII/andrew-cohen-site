...
export function NavigationModal({ isOpen, onClose, pageSlug }: NavigationModalProps) {
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className={`fixed inset-x-0 bottom-0 ${SITE_HEADER_OFFSET_CLASS} z-[60] bg-black/80 backdrop-blur-sm transition-opacity duration-300 ${
      ...
      {/* Modal */}
      <div className={`fixed inset-x-0 bottom-0 ${SITE_HEADER_OFFSET_CLASS} z-[60] flex items-center justify-center p-4 pointer-events-none`}>
        <div 
