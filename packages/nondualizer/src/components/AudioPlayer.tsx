...
import { Slider } from "@nondualizer/components/ui/slider";
import { Popover, PopoverContent, PopoverTrigger } from "@nondualizer/components/ui/popover";
import { TrackDrawer } from "./TrackDrawer";
import { BackgroundSlideshow } from "./BackgroundSlideshow";
import { CaptionOverlay } from "./CaptionOverlay";
import { ShareModal } from "./ShareModal";
import { WelcomeModal } from "./WelcomeModal";
import { parseSrtFile, type Caption } from "@nondualizer/lib/utils";
import { useNondualizerRouter } from "@nondualizer/router-context";
import { assetPath } from "@nondualizer/config";
...
} from "@nondualizer/lib/analytics";
...
const mockTracks: Track[] = [
  {
    ...
    audioUrl: assetPath("/audio/What is Nonduality.m4a"),
  ...
  },
  {
    ...
    audioUrl: assetPath("/audio/What is Ego Death.m4a"),
  ...
  },
  {
    ...
    audioUrl: assetPath("/audio/The Four Selves.m4a"),
  ...
  },
  {
    ...
    audioUrl: assetPath("/audio/Rational Idealism.m4a"),
  ...
  },
  {
    ...
    audioUrl: assetPath("/audio/Realization and Transformation.m4a"),
  ...
  },
  {
    ...
    audioUrl: assetPath("/audio/Realigning the Soul.m4a"),
  ...
  },
  {
    ...
    audioUrl: assetPath("/audio/The Evolution of Nonduality.m4a"),
  ...
  },
  {
    ...
    audioUrl: assetPath("/audio/The Edge of Evolution.m4a"),
...
const backgroundMusicTracks = [
  {
    ...
    audioUrl: assetPath("/background-music/sunrise-meditation-369921.mp3")
  },
  {
    id: "bg2",
    title: "Aura",
    description: "Radiant energy fields and subtle vibrations",
    audioUrl: assetPath("/background-music/quiet-contemplation-meditation-283536.mp3")
  },
  {
    id: "bg3",
    title: "Into Silence",
    description: "The profound depth of inner stillness",
    audioUrl: assetPath("/background-music/autumn-sky-meditation-7618.mp3")
  },
  {
    id: "bg4",
    title: "Resonance",
    description: "Harmonic frequencies that align the soul",
    audioUrl: assetPath("/background-music/meditation-relax-sleep-music-346733.mp3")
  },
  {
    id: "bg5",
    title: "Transcendence",
    description: "Beyond the boundaries of ordinary perception",
    audioUrl: assetPath("/background-music/meditate-meditation-music-346429.mp3")
  },
  {
    id: "bg6",
    title: "Luminescence",
    description: "The inner light that guides transformation",
    audioUrl: assetPath("/background-music/meditation-yoga-relaxing-music-378307.mp3")
  },
  {
    id: "bg7",
    title: "Essence",
    description: "The core truth that lies beneath all experience",
    audioUrl: assetPath("/background-music/meditation-music-338902.mp3")
  },
  {
    id: "bg8",
    title: "Awakening",
    description: "The moment when consciousness realizes itself",
    audioUrl: assetPath("/background-music/meditation-music-322801.mp3")
  },
  {
    id: "bg9",
    title: "Unity",
    description: "The seamless oneness of all existence",
    audioUrl: assetPath("/background-music/meditation-yoga-relaxing-music-380330.mp3")
  }
];
...
export function AudioPlayer({ initialTrackIndex = 0 }: AudioPlayerProps) {
  const { navigate } = useNondualizerRouter();
  ...
  useEffect(() => {
    const loadCaptions = async () => {
      try {
        ...
        if (srtFileName) {
          const srtResponse = await fetch(assetPath(`/transcripts/${srtFileName}`));
          if (srtResponse.ok) {
